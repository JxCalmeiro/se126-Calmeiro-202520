...
def converter(f):
    #'f' is a parameter
    '''this function is passed an argrument value of 'f' (a tempF), converts to tempC, and then returns the conversion value'''
    c = (f - 32) * (5 / 9)
...
while answer == "y" or answer == "Y":
    ...
    temp_count = temp_count + 1 #temp_count += 1 <-- short hand code
    temp_total += tempF
